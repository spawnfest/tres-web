...
config :inspector_daya, InspectorDayaWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: InspectorDayaWeb.ErrorView, accepts: ~w(html json), layout: false],
...
config :inspector_daya, InspectorDaya.Mailer, adapter: Swoosh.Adapters.Local
